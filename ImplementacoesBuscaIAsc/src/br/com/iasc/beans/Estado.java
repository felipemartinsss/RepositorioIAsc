...
public class Estado {
	...
	public Estado(String alias, List<String> nomesVariaveis,
			List<Boolean> valoresVariaveis) {
		this.alias = alias;
	...
	public String toString() {
		...
		for (int i = 0; i < this.nomesVariaveis.size(); i++) {
			descricaoEstado.append(" " + (String) this.nomesVariaveis.get(i)
					+ " = " + this.valoresVariaveis.get(i) + " ");
		}
