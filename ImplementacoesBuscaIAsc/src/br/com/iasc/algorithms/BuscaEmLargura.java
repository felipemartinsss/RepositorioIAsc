...
/**
 * Implementação do algoritmo conhecido como Busca em Largura. O algoritmo usa a
 * lista ligada estadosParaExploracao como uma fila para definir a ordem de
 * visitação dos estados.
 * 
